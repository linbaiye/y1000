...
public class PlayerWeaponAnimation: AbstractPlayerAnimation<PlayerWeaponAnimation>
{
    ...
    {
        AtzSprite nonattack = ISpriteRepository.Instance.LoadByNumberAndOffset(name, new Vector2(16, -12));
        //AtzSprite attack = AtzSprite.LoadOffsetWeaponSprites(attackName);
        AtzSprite attack = ISpriteRepository.Instance.LoadByNumberAndOffset(attackName, new Vector2(16, -12));
