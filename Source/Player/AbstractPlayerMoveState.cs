...
public abstract class AbstractPlayerMoveState: AbstractPlayerState
{
    ...
    protected AbstractPlayerMoveState(SpriteManager spriteManager, Direction towards, long elapsedMillis = 0) : base(spriteManager, elapsedMillis)
    {
        _towards = towards;
        _directionChanged = false;
    }

    protected abstract void OnMoved(Player player);
    ...
    public static SpriteManager CreateWalkSpriteManager()
    {
        return SpriteManager.Normal(SpriteLengthMillis, SPRITE_OFFSET, SpriteContainer.LoadMalePlayerSprites("N02"));
    }
}