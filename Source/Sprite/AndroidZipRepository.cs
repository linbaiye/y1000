...
public class AndroidZipRepository : AbstractSpriteRepository
{

	public static readonly AndroidZipRepository Instance = new();
    
	private AndroidZipRepository() {}
	...
	private ZipArchive GetZipDataFromBinary(byte[] data)
	{
